...
class CustomSearchFilter extends StatefulWidget {
  ...
  const CustomSearchFilter({super.key, required this.onSearch});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: theme.colorScheme.shadow.withOpacity(0.05), blurRadius: 12, offset: const Offset(0, 2)),
        ],
      ),
      child: TextField(
