...
class AppointmentTile extends StatelessWidget {
  final Map<String, dynamic> appointmentDetail;
  final VoidCallback onTap;

  const AppointmentTile({super.key, required this.appointmentDetail, required this.onTap});

  Color _getStatusColor(BuildContext context) {
    final theme = Theme.of(context);
    switch (appointmentDetail['status'].toLowerCase()) {
      case 'booked':
        return Colors.teal;
      case 'prescribed':
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      _formatDate(DateTime.parse(appointmentDetail['appointment_date'])),
                      style: theme.textTheme.bodySmall?.copyWith(color: Colors.white, fontWeight: FontWeight.w600),
                      textAlign: TextAlign.center,
                    ),
                    Text(
                      _formatTime(DateTime.parse(appointmentDetail['appointment_date'])),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      formatValue(appointmentDetail['patients']?['full_name']),
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            formatValue(appointmentDetail['doctors']?['full_name']),
                    ...
                    Container(
                      ...
                      child: Text(
                        formatValue(appointmentDetail['status']),
