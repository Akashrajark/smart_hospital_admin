...
class PatientDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _buildProfileContent(context, patient),
    );
  }
}
    ...
    child: Column(
      ...
      children: [
        ...
        _buildInfoTile(
          context,
          'Current Medications',
          profileData['current_medication'],
          Icons.medication,
          isOptional: true,
        ),
      ...
      children: [
        Material(
          ...
          child: ClipRRect(
            ...
            child: profileData['image_url'] != null
                ? Image.network(
        ...
        Text(
          ...
          style: Theme.of(
            context,
          ).textTheme.bodyMedium?.copyWith(color: Theme.of(context).colorScheme.onPrimaryContainer.withOpacity(0.8)),
        ),
      ],
    ),
  );
